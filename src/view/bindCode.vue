          ...
          <div class="modify">
            <div class="activation">
              <div class="expansion">
                ...
                <div class="centCode" style="display: none;">
                  版本：
                </div>
                <div class="centCode" style="display: none;">
                  有效期：
                ...
                <div class="Prev" style="display: none;" @click="pre">上一步</div>
              </div>
              <div class="text"><i style="text-align: center;">小提示：</i> <i><span class="spans">1、</span><span
                  class="span">扫码后需要同意相关授权，否则无法使用本站提供的所有功能！</span></i> <i><span class="spans">2、</span><span
                  class="span">同一个账号可绑定多个微信号，但需要增加新的激活码（每个激活码绑定一个微信号）</span></i> <i><span class="spans">3、</span><span
                  class="span">同一个账号可同时上线多个微信号，但需要设置一个微信号为主账号，主账号可使用产品内的所有功能（主账号可切换）</span></i></div>
            </div>
          </div>
        </div>
      </div>
    </div>
    <wx-q-r-code :name="name" :show="popupShow" :qrcode="qrcode"></wx-q-r-code>
  </div>
</template>
